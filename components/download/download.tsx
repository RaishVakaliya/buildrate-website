    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="max-w-4xl mx-auto rounded-3xl border border-border/80 bg-card/60 p-8 sm:p-12 md:p-14 text-center backdrop-blur-md"
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-5">
            <a
              ...
              className="inline-flex items-center gap-3.5 px-5 py-3 rounded-2xl bg-black/90 hover:bg-black border border-white/20 hover:border-white/40 text-white transition-all duration-200 shadow-lg shadow-black/50 hover:scale-[1.02] active:scale-[0.98] min-w-[200px] text-left cursor-pointer"
            >
              <Image
